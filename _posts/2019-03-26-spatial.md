...
# or just coordinate reference system (crs)

crs(tay)

# number of cells or dimension
...
```r
# OPTIONAL:Careful as this step will overwrite your data. You don't need to execute this step to proceed with the tutorial.
